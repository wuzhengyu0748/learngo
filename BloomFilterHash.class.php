...
class BloomFilterHash
{
     ...
     * @return int
     */
    public function JSHash($string, $len = 0)
    {
        $hash = 1315423911;
     ...
     * @return int
     */
    public function PJWHash($string, $len = 0)
    {
     ...
     * @return int
     */
    public function ELFHash($string, $len = 0)
    {
        $hash = 0;
        $len || $len = strlen($string);
        for ($i = 0; $i < $len; ++$i) {
     ...
     * @return int
     */
    public function BKDRHash($string, $len = 0)
    {
     ...
     * @return int
     */
    public function SDBMHash($string, $len = 0)
    {
        $hash = 0;
        $len || $len = strlen($string);
        for ($i = 0; $i < $len; ++$i) {
     ...
     * @return int
     */
    public function DJBHash($string, $len = 0)
    {
        $hash = 5381;
        $len || $len = strlen($string);
        for ($i = 0; $i < $len; ++$i) {
     ...
     * @return int
     */
    public function DEKHash($string, $len = 0)
    {
        $len || $len = strlen($string);
        $hash = $len;
        for ($i = 0; $i < $len; ++$i) {
     ...
     * @return int
     */
    public function FNVHash($string, $len = 0)
    {
